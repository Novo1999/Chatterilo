...
const ChatUserItem = () => {
  return Array.from({ length: 10 }).map((_, index) => {
    return (
      <div
        key={index}
        className='grid grid-cols-[50px_130px_50px] min-[375px]:grid-cols-[50px_190px_40px] min-[425px]:grid-cols-[50px_240px_50px] md:grid-cols-[50px_180px_50px] lg:grid-cols-[50px_250px_50px] gap-4 xl:grid-cols-[50px_250px_50px] *:text-gray-200'
      >
        <Image
